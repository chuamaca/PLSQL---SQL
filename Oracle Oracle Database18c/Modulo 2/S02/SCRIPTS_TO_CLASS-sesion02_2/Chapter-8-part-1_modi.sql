...
BEGIN
OPEN c_emp_dept30; -- cuando se abre el cursor oracle ejecuta el select en memoria *

  loop
      fetch c_emp_dept30 into v_empno, v_first_name; -- con el fetch guardo en la variable
...
DECLARE
  ...
  where department_id=30;
   ...
   v_emp_rec employees%rowtype;  --- otra definicion de la variable
