...
begin
   select emp_id, full_name,
          mob1,mob2,landline
   into   v_rec.v_emp_id,v_rec.v_full_name, -- dependiendo de la ubicacion en la declaracion
   -- ... observar como se le describe a los de la parte superior: XXXX.XXXX
   -- en la sgte linea se hace descripcion a xxxx.xxxx.xxxx xq se refiere a NESTED record
