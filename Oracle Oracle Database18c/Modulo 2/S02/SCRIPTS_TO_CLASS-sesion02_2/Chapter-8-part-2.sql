...
BEGIN
-- el siguiente bloque de codigo es vital 
/* sucede que con este bloque te aseguras que si te olvidas de "cerrar" el cursor
Si el cursor esta abierto, entonces, no hagas nada. Si esta cerrado, abrelo.
*/
--- ====== inicio ================
...
/* el for loop cursor, no necesita open, close o fetch para manejar
cursores.
*/
BEGIN
