--ejemplo de INDEX BY TABLE (associative varrays)
-- primera manera
declare
...
begin
-- empiezo a llenar el arreglo : (ademas lo que esta entre () es el indice-pls_integer)
v_tab_no(1):='khaled';
v_tab_no(6):='ahmed';
v_tab_no(4):='jad';
...
-------------------------
-- segunda manera: cambiando los indices y los valores del arreglo es number
declare
...
index by pls_integer;
-- primer loop para poblar el array
v_tab_emp tab_emp;
v_name varchar2(100);
begin
for i in 100..110
