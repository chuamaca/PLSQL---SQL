...
--here we use the case as expression
-- CASE EXPRESSION siempre retornan un valor.
-- case expressin solamente contiene un CASE y no un END CASE
-- CASE STATEMENT colocas una "oracion" como una sentencia DBMS_OUTPUT (ejecutas acciones)
DECLARE
v_sal number;
v_desc varchar2(100);
BEGIN
