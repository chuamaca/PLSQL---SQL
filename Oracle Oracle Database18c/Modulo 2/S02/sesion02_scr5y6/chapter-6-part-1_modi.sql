...
DECLARE
-- cuando usas el & el oracle te permite ingresar el valor como un parametro.
v_no NUMBER:=&v;
BEGIN
   IF v_no >=10 THEN
...
END;
---------------------------------
-- pero el codigo anterio puede ser mas eficiente.
-- colocandole un IF adicional.
...
*/
-- la variable de sustitucion &emp_id tomará el valor del employee_id que ingrese
-- y luego la guardara en la variable v_sal
