-- con el user hr
-- solo basta con dar privilegios al procedure para que en auto el user ya 
-- herede el privilegio para el dml. 
...
-- INVOKER RIGHTS:
-- aca sí se necesita dar el privilegio a la tabla que sera afectada en el procedure
