...
-------------------------
execute general_student.insert_student ('khaled ahmed','10/05/1981');

execute general_student.insert_student ('samer ahmed','10/05/1982');
