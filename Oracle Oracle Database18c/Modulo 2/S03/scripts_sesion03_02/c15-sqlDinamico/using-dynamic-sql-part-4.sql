...
-- let us review the normal cursor
DECLARE
...
-----------------------------------
-- ref cursor. Se puede abrir muchas veces.
...
execute emp_list;
-- me devuelve todos los registros de la tabla.

-- pero si lo ejecuto con parametro (30) me devuelve los del dptop 30
