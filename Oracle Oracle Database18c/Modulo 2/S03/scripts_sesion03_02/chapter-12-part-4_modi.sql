...
-- recuerda que ebgin es opcional:
 begin
...
c_var1 constant number:=10;
c_var2 varchar2(100):='welcome';
p_n number; -- se agregar esta var
procedure print;
function get_name (p number) return varchar2; -- se agrega esta fnc
end;

execute p_test.print; -- verificar si es que da error o no.
