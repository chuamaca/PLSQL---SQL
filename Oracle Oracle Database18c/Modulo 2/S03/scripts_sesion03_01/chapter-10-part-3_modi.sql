-- IN OUT PARAMETER. 
-- normalmente no es muy usado en la vida real.
...
execute :b_telephone:='971505914988';  -- esta instruccion es mandatoria para iniciarlizar la bind variable
