...
select employee_id, first_name, salary, get_sal_tax(salary) -- possitional calling
from employees;

select employee_id, first_name, salary, get_sal_tax(p_sal=>salary) -- naming notation method
from employees;
